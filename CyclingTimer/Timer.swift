...
let testData = [
    ...
    Timer(name: "HIIT Workout", segments: [
        ...
        Segment(sets: [Set(description: "All out", duration: 30, rpm: 100, effort: 10),
                       Set(description: "Recovery", duration: 60, rpm: 85, effort: 3)], repetitions: 10, type: .work),
        
        Segment(sets: [Set(description: "Cooldown", duration: 180, rpm: 75, effort: 4)], type: .cooldown)
    ]),
    
    Timer(name: "40 20", segments: [
        ...
        Segment(sets: [Set(description: "Recovery", duration: 240, rpm: 75, effort: 4)], type: .work),
