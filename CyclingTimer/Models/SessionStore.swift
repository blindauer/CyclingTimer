...
let testData = [
    ...
    Session(name: "Testing", segments: [Segment(sets: [Set(description: "Segment 1 Set 1", duration: 5, rpm: 75, effort: 4),
                                                       Set(description: "Segment 1 Set 2", duration: 6, rpm: 75, effort: 4)], type: .warmup),
                                        Segment(sets: [Set(description: "Segment 2 Set 1", duration: 5, rpm: 75, effort: 4),
                                                       Set(description: "Segment 2 Set 2", duration: 6, rpm: 75, effort: 4)], type: .work)
    ]),
